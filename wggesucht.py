def main():
    ...
    if selected == "🏘️ Apartments":
        ...
        with col2:
            st.markdown("<img src='https://soundcloud.com/groddinc/grodd-inc-global-podcast-series-32-wibrahim-murat?in=groddinc/sets/global-podcast-series'></img>", unsafe_allow_html=True)
