def main():
    ...
    if selected == "🏘️ Apartments":
        ...
        with col3:
            ...
            oldestdate = str(df_concat["Posting Date"].min())[:10]
        ...
        with col3:
            ...
            df_pivot_neighbourhoods = df_pivot_neighbourhoods
            ...
            wholechart = alt.layer(chart.mark_bar(color="orange"), chart.mark_text(align='left', dx=8, color="black", angle=330))
            ...
            chart = alt.Chart(df_concat_pivot_releasedate).encode(
                ...
                y=alt.Y('month(Posting Date):O', axis=alt.Axis(title='Entry date')), #use 'sort=None' to preserve the order of categories
