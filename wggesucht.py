def main():
    ...
    if selected == "🏘️ Apartments":
        ...
        df_timeline_pivotedby_dataframedate_test = ['_'.join(col).strip() for col in df_timeline_pivotedby_dataframedate.columns.values]
        st.write(df_timeline_pivotedby_dataframedate_test)
